...
public class FdCalculatorPage extends Wrapperclass{
	...
	{
		String deposit=readExcelString("src\\test\\resources\\TESTDATA\\ICICI_data.xlsx","Sheet1",1,0);
	...
	{
		int amount=readExcel("src\\test\\resources\\TESTDATA\\ICICI_data.xlsx","Sheet1",1,1);
